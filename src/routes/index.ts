...
export const ROUTE_PATHS = {
  ...
  DASHBOARD_ROLES: ROUTES.DASHBOARD_ROLES,
  DASHBOARD_EMPLOYEES: ROUTES.DASHBOARD_EMPLOYEES,
  DASHBOARD_LEAVES: ROUTES.DASHBOARD_LEAVES,
  DASHBOARD_PAYROLL: ROUTES.DASHBOARD_PAYROLL,
  DASHBOARD_PERFORMANCE: ROUTES.DASHBOARD_PERFORMANCE,
  DASHBOARD_TALENT: ROUTES.DASHBOARD_TALENT,
  DASHBOARD_ADD_EMPLOYEE: ROUTES.DASHBOARD_ADD_EMPLOYEE,
  DASHBOARD_ADD_ROLE: ROUTES.DASHBOARD_ADD_ROLE,
  DASHBOARD_REQUEST_LEAVE: ROUTES.DASHBOARD_REQUEST_LEAVE,
  DASHBOARD_ADD_PERFORMANCE: ROUTES.DASHBOARD_ADD_PERFORMANCE,
  DASHBOARD_ADD_TALENT: ROUTES.DASHBOARD_ADD_TALENT,
  // Detail routes
