...
import ContactsTable from "@/components/custom/custom-table";
import { RiScanLine } from "@remixicon/react";
import { StatsGrid } from "@/components/custom/stats-grid";
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Here&rsquo;s an overview of your contacts. Manage or create
                  new ones with ease!
                </p>
              </div>
